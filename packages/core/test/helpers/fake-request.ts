...
export function fakeRequest(opts: { method?: string; originalUrl?: string; url?: string; body?: unknown; query?: Record<string, unknown>; headers?: Record<string, string> } = {}): InertiaRequest {
